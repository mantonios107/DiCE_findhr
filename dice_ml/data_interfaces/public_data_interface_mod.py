...
class PublicData(_BaseData):
    ...
    def __init__(self, params):
        ...
        self.categorical_feature_names = params.get('categorical_features', [])
        self.setlist_feature_names = params.get('setlist_features', [])
        ...
        self.dist_fun_setlist = params.get('dist_function_setlist', None)
    ...
    def _set_feature_dtypes(self, data_df, categorical_feature_names,
                            continuous_feature_names, setlist_feature_names):
